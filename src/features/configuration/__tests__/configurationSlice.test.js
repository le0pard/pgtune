...
describe('selectDefaultStatisticsTarget', () => {
  it('web app', () => {
    expect(selectDefaultStatisticsTarget({
      configuration: {
        dbType: 'web'
      }
    })).toEqual(100)
...
describe('selectEffectiveIoConcurrency', () => {
  it('hdd', () => {
    expect(selectEffectiveIoConcurrency({
      configuration: {
        osType: 'linux',
        hdType: 'hdd'
      }
